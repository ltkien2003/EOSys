...
public class DangNhapJDialog extends javax.swing.JDialog {
    ...
    void dangNhap() {
        ...
        if (nhanVien == null && nguoiDung == null) {
            ...
            txtMaNV.requestFocus();
        } else if (nhanVien != null && !argon2.verify(nhanVien.getMatKhau(), matkhau)) {
            MsgBox.alert(this, "Tên đăng nhập hoặc mật khẩu không hợp lệ");
            txtMatKhau.requestFocus();
        } else if (nguoiDung != null && !argon2.verify(nguoiDung.getMatKhau(), matkhau)) {
            MsgBox.alert(this, "Tên đăng nhập hoặc mật khẩu không hợp lệ");
            txtMatKhau.requestFocus();
        } else if (nhanVien != null && argon2.verify(nhanVien.getMatKhau(), matkhau)) {
            Auth.user = nhanVien;
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btnDangNhap, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)

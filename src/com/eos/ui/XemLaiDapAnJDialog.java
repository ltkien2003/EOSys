...
public class XemLaiDapAnJDialog extends javax.swing.JFrame {
    ...
    private void loadData() {
        ...
        if (ctdtlist.get(i).getPALuaChon() == null) {
            lblNoiDungCauHoi.setText("<html><div style=\"padding: 10px;color:red;\"><prev>" + list.get(i).getTenCH() + "</prev><div></html>");
            ...
            lblNoiDungCauHoi.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getTenCH() + "</prev><div></html>");
            lblPA1.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA1() + "</prev><div></html>");
            lblPA2.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA2() + "</prev><div></html>");
            lblPA3.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA3() + "</prev><div></html>");
            lblPA4.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA4() + "</prev><div></html>");
    ...
    private void kiemTraPADaChon() {
        String PADaChon = "<html><div style=\"padding: 10px;\"><prev>" + ctdtlist.get(i).getPALuaChon() + "</prev><div></html>";
        ...
        if (PADaChon.equals(dapAn)) {
            if (lblPA1.getText().equals(PADaChon)) {
                ...
                lblPA1.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA1() + correct + "</prev><div></html>");
            } else if (lblPA2.getText().equals(PADaChon)) {
                rdoPA2.setSelected(true);
                lblPA2.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA2() + correct + "</prev><div></html>");
                lblPA2.setForeground(new Color(0, 103, 192));
            } else if (lblPA3.getText().equals(PADaChon)) {
                rdoPA3.setSelected(true);
                lblPA3.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA3() + correct + "</prev><div></html>");
                lblPA3.setForeground(new Color(0, 103, 192));
            } else if (lblPA4.getText().equals(PADaChon)) {
                rdoPA4.setSelected(true);
                lblPA4.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA4() + correct + "</prev><div></html>");
            ...
            if (lblPA1.getText().equals(PADaChon)) {
                ...
                lblPA1.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA1() + uncorrect + "</prev><div></html>");
            } else if (lblPA2.getText().equals(PADaChon)) {
                rdoPA2.setSelected(true);
                lblPA2.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA2() + uncorrect + "</prev><div></html>");
                lblPA2.setForeground(Color.RED);
            } else if (lblPA3.getText().equals(PADaChon)) {
                rdoPA3.setSelected(true);
                lblPA3.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA3() + uncorrect + "</prev><div></html>");
                lblPA3.setForeground(Color.RED);
            } else if (lblPA4.getText().equals(PADaChon)) {
                rdoPA4.setSelected(true);
                lblPA4.setText("<html><div style=\"padding: 10px;\"><prev>" + list.get(i).getPA4() + uncorrect + "</prev><div></html>");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(rdoPA4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)
                    .addComponent(rdoPA3, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)
                    .addComponent(rdoPA2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(rdoPA1, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(rdoPA1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lblPA1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(rdoPA2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblPA2, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(15, 15, 15)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rdoPA3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblPA3, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(15, 15, 15)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rdoPA4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblPA4, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(39, 39, 39)
                        .addComponent(lblNoiDungCauHoi, javax.swing.GroupLayout.PREFERRED_SIZE, 686, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblTenQuiz)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XemLaiDapAnJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
